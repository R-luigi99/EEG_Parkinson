...
for j in range(62):
    for i in range(27):
        NewMex_ON_DF[NewMex_ON_media['Channel_location'][j] + '_media'].append(NewMex_ON_media['EEG'][j][0][i])
        NewMex_ON_DF[NewMex_ON_media['Channel_location'][j] + '_media'].append(NewMex_ON_media['EEG'][j][1][i])
        NewMex_ON_DF[NewMex_ON_varianza['Channel_location'][j] + '_varianza'].append(NewMex_ON_varianza['EEG'][j][0][i])
        NewMex_ON_DF[NewMex_ON_varianza['Channel_location'][j] + '_varianza'].append(NewMex_ON_varianza['EEG'][j][1][i])
        NewMex_ON_DF[NewMex_ON_max['Channel_location'][j] + '_max'].append(NewMex_ON_max['EEG'][j][0][i])
        NewMex_ON_DF[NewMex_ON_max['Channel_location'][j] + '_max'].append(NewMex_ON_max['EEG'][j][1][i])
        NewMex_ON_DF[NewMex_ON_min['Channel_location'][j] + '_min'].append(NewMex_ON_min['EEG'][j][0][i])
        NewMex_ON_DF[NewMex_ON_min['Channel_location'][j] + '_min'].append(NewMex_ON_min['EEG'][j][1][i])
        NewMex_ON_DF['PD'].append(0)
        NewMex_ON_DF['PD'].append(1)
        NewMex_ON_DF['Levodopa'].append(0)
        NewMex_ON_DF['Levodopa'].append(1)

NewMex_ON_DF['PD'][54:] = []


with open("NewMexON_54.csv", "w") as outfile2:
